...
<main class="flex flex-col gap-5 h-screen bg-secondary p-10 w-full">
  <div class="flex justify-center w-full left-1">
     <div id="messages-container" class="flex flex-col gap-2">
       
    </div>
  </div>
  <div class="w-full flex flex-row gap-5 items-center h-full">
    <div class="flex flex-col justify-center gap-5 w-[50%]">
      ...
      if (isset($products[0]['productId'])) {
        ...
        echo '<h1 class="text-center font-latobold text-6xl">Añada productos al carrito :(</h1>';
      }
      ?>
    </div>
